...
namespace ConsoleUI
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            BaseService<Product> productService = new BaseService<Product>();
            BaseService<Category> categoryService = new BaseService<Category>();

            var result = productService.GetList(); // listeleme okey
